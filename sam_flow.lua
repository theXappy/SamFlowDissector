--------------------------------------------------------------------------------------------------
--
-- This file was generated by SamFlowDissectorGenerator (Version 1.0.0.0)
-- S*msungFlowFramework.NET.dll Creation Time: {flowFrameworkCreationTime}
-- S*msungFlowFramework.NET.dll Version: AuthVer: 11, AuthVerMin: 9, NotifVer: 11, NotifVerMin: 9
-- Dissector generation time: 13/02/2021 12:01:45
--
--------------------------------------------------------------------------------------------------
...
local p_sam_flow_priv = Proto("flow_priv", "Sam" .. "sung Flow Protocol Private")
...
p_sam_flow_priv.experts = {
	e_private_keepalive,
	e_private_dec_fail,
	e_private_dec_missing_param
}

p_sam_flow_priv.prefs.hide_nulls = Pref.bool("Hide NULL fields", true, "Whether to show fields with the value of 'null' literally (4 ASCII chars)")
p_sam_flow_priv.prefs.key = Pref.string("Key", "", "Key for decryption. Format is 16 bytes in hex.")
p_sam_flow_priv.prefs.iv = Pref.string("IV", "", "IV for decryption")

-- a function for handling prefs being changed
function p_sam_flow_priv.prefs_changed()
	global_flow_settings.hide_nulls = p_sam_flow_priv.prefs.hide_nulls
	global_flow_settings.key = p_sam_flow_priv.prefs.key
	global_flow_settings.iv = p_sam_flow_priv.prefs.iv
end
...
function p_sam_flow_priv.dissector(buf, pkt, tree)
		...
		local subtree = tree:add(p_sam_flow_priv, buf:range())
...
function p_sam_flow_bc.dissector(buf, pkt, tree)
		...
		if notif_bc_port ~= nil then
			tcp_port_table:add(notif_bc_port, "p_sam_flow_priv")
		end
